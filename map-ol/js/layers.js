...
define(['ol', "config"], function (ol, config) {
    ...
    var tiandituSatellite = new ol.layer.Tile({
        ...
        source: new ol.source.XYZ({
            ...
            url: 'http://t3.tianditu.gov.cn/DataServer?T=img_w&x={x}}&y={y}&l={z}&tk=45c78b2bc2ecfa2b35a3e4e454ada5ce'
        })
    });
    var tiandituSatelliteLabel = new ol.layer.Tile({
        ...
        source: new ol.source.XYZ({
            ...
            url: "http://t3.tianditu.gov.cn/DataServer?T=cia_w^&x={x}^&y={y}^&l={z}^&tk=45c78b2bc2ecfa2b35a3e4e454ada5ce"
        })
    });
    ...
    var offlineMapLayer = new ol.layer.Tile({
        source: new ol.source.XYZ({
            ...
            url: config.map.mapTileUrl + '{z}/{x}/{y}.png'
            // url: './resource/offlineMapTile/googleMap/{z}/{x}/{y}.png'
            // url: './resource/offlineMapTile/tianditu/Img/{z}/{x}/{y}.png'
        })
    });
    //离线标注
    var offlineMapLabel = new ol.layer.Tile({
        source: new ol.source.XYZ({
            // url: './resource/offlineMapTile/tianditu/ImgLabel/{z}/{x}/{y}.png'
        })
    })
    ...
    var layers = {
        ...
        offlineMapLayer: offlineMapLayer, //离线地图
        offlineMapLabel: offlineMapLabel //离线地图标注
    };
    return layers;
});